...
function Card() {
  return (
    <div>
      <div class="card-container w-[96%] h-[40%] absolute rounded-lg">
        <div class="card w-full h-full overflow-hidden rounded-[inherit]">
          <div class="img-content w-full h-full flex items-center justify-center">
            <svg
              ...
              fill-rule="evenodd"
              clip-rule="evenodd"
              className=" w-[50px] h-[50px] fill-[#212121] transition-all duration-[0.6s] ease-[cubic-bezier(0.23,1,0.320,1)]"
            >
              <path
                fill-rule="nonzero"
          ...
          <div class="content absolute w-full h-full flex flex-col justify-center gap-2.5 text-[#e8e8e8] leading-normal opacity-0 pointer-events-none translate-y-[50px] transition-all duration-[0.6s] ease-[cubic-bezier(0.23,1,0.320,1)] px-6 py-5 rounded-[5px] left-0 top-0">
            <p class="heading text-[32px] font-bold">Card Hover</p>
            <p>
